// Playwright webServer: a fresh local Worker for the e2e suite. From ../worker it wipes app/tests/.state-<port>, applies
// the D1 migrations into it (--local), then runs wrangler dev on E2E_PORT (inspector +10) with TEST_MODE=1.
